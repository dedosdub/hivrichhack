...
local Window = Library:CreateWindow({
    Name = "vladhivrich666 cheat",
    LoadingTitle = "Loading Brain",
    LoadingSubtitle = "By vladhivirc666",
    ConfigurationSaving = {
        Enabled = false,
    ...
    KeySettings = {
        Title = "1",
        Subtitle = "хз иди нахуй крякер сосой",
        Note = "discord.gg/Tyq3YnM2yP",
        FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
        SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
        GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
        Key = {"kaksosathyinaychyzatriminyti"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
...
if true then
    ...
    do
        ...
        Home:CreateLabel("Premium Version(pizdesh ya spastil)")
        Home:CreateLabel("Version: ".. Version)
        Home:CreateLabel("Hyi: pobrit")
    end
    ...
    do
        ...
        Combat:CreateSection("Character aaaaa sosi hyi")
        Combat:CreateToggle({
            Name = "Spin in penis",
            CurrentValue = false,
            Flag = "Spinbot",
    ...
    do
        ...
        Misc:CreateToggle({
            Name = "Remove Perdesh bati(smoke)",
            CurrentValue = false,
            Flag = "RemoveSmoke",
            Callback = function(Value)
